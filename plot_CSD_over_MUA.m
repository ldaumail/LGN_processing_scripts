...
aMUA = load(strcat(filename, '_aMUA.mat'));  
LFP = load(strcat(filename, '_LFP.mat')); 
CSD = load(strcat(filename, '_CSD.mat'));
...
f = {'dom0_nondomsup50','domsup50_nondom0','domsup50_domsup50'};
...
%no normalization for CSD
   ...
   norm_mean_CSD = mean_CSD .* 50/scalingfactor; 

...
figure, 
 plot(x_stim,normspec', 'LineWidth',1, 'Color',[167/255 185/255 54/255])
 xlim([-600 1250])
 ylim([-0.1 1])
 %green[167/255 185/255 54/255])
 %black = [24/255 23/255 23/255] )
...
filename = strcat('C:\Users\maier\Documents\LGN_data\single_units\inverted_power_channels\good_single_units_data_4bumps_more\power_spectrum\plots\',contrast{2},'indiv_normalized_power_freq_time_mean_95ci_K_layer_4hz_gathered_green_sig_suamean_pow');
saveas(gcf, strcat(filename, '.svg'));
saveas(gcf, strcat(filename, '.png'));
%export_fig(gcf, '-jpg', '-transparent');
